...
| P1 | 磨き込み: レンズ切替・ズーム・保存サムネイル・非線形スライダー調整・実機チューニング・1080p 実測ゲート(01 §1.1)・回転モデル自己診断(06 §3.3)・メディアフレーム演出(04 §7)・シャッター音の年代連動・版画の地域プリセット(和/洋。03 §5)・パラメータ直接操作のデバッグ隠し画面 | 初回リリース版 |
